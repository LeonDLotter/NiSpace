...
For questions about the toolbox, analysis choices, or if you need help with its application, we recommend opening a new topic on `NeuroStars <https://neurostars.org/>`_ using the tag `"nispace" <https://neurostars.org/tag/nispace>`_.
...
We will post regular updates on new features and releases on `NeuroStars <https://neurostars.org/tags/c/announcements/6/nispace>`__.  
